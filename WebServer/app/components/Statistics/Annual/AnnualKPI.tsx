...
export interface AnnualKPICard {
  label: string;
  value: number;
  subtitle: string;
...
interface AnnualKPIProps {
  cards: AnnualKPICard[];
}

const AnnualKPI: React.FC<AnnualKPIProps> = ({ cards }) => {
  return (
        ...
        >
          <div className="card-body p-4 sm:p-6 relative overflow-hidden">
            ...
            <div className="relative">
              <div className="badge badge-neutral gap-2 mb-3">
...
export { BarChart3, FileText, Gavel, Scale };
export default AnnualKPI;
