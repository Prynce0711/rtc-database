...
export const ReceiveLogSchema = z.object({
...
export type ReceiveLogSchema = z.infer<typeof ReceiveLogSchema>;

export const initialReceiveLogFormData: ReceiveLogSchema = {
  receiptNo: "",
