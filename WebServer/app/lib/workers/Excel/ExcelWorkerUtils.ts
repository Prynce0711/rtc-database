...
export enum ExcelTypes {
  ...
  SHERIFF_CASE = "SHERIFF_CASE",
  SPECIAL_PROCEEDING_CASE = "SPECIAL_PROCEEDING_CASE",
  EMPLOYEE = "EMPLOYEE",
  NOTARIAL_COMMISSION = "NOTARIAL_COMMISSION",
  MUNICIPAL_TRIAL_COURT = "MUNICIPAL_TRIAL_COURT",
  REGIONAL_TRIAL_COURT = "REGIONAL_TRIAL_COURT",
  INVENTORY_DOCUMENT = "INVENTORY_DOCUMENT",
  MUNICIPAL_JUDGEMENT = "MUNICIPAL_JUDGEMENT",
  REGIONAL_JUDGEMENT = "REGIONAL_JUDGEMENT",
