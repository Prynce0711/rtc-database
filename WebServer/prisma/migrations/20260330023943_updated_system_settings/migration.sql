...
INSERT INTO "new_SystemSettings" ("backupFrequency", "createdAt", "id", "lockoutThreshold", "logRetention", "maintainanceMode", "passwordExpiration", "senderEmail", "sessionTimeout", "smtpHost", "smtpPort", "systemAnnouncement", "updatedAt") SELECT "backupFrequency", "createdAt", "id", "lockoutThreshold", "logRetention", "maintainanceMode", "passwordExpiration", "senderEmail", "sessionTimeout", "smtpHost", "smtpPort", "systemAnnouncement", "updatedAt" FROM "SystemSettings";
