...
INSERT INTO "new_CivilCase" ("caseNumber", "consolidationBranch", "consolitationDate", "createdAt", "dateRemanded", "defendants", "id", "nature", "notes", "originCaseNumber", "petitioners", "reRaffleBranch", "reRaffleDate", "remandedNote", "undocketed", "updatedAt") SELECT "caseNumber", "consolidationBranch", "consolitationDate", "createdAt", "dateRemanded", "defendants", "id", "nature", "notes", "originCaseNumber", "petitioners", "reRaffleBranch", "reRaffleDate", "remandedNote", "undocketed", "updatedAt" FROM "CivilCase";
...
INSERT INTO "new_Log" ("action", "createdAt", "details", "id", "ipAddress", "timestamp", "updatedAt", "userAgent", "userId") SELECT "action", "createdAt", "details", "id", "ipAddress", "timestamp", "updatedAt", "userAgent", "userId" FROM "Log";
DROP TABLE "Log";
...
INSERT INTO "new_Petition" ("caseNumber", "createdAt", "date", "id", "nature", "petitioner", "raffledTo", "updatedAt") SELECT "caseNumber", "createdAt", "date", "id", "nature", "petitioner", "raffledTo", "updatedAt" FROM "Petition";
DROP TABLE "Petition";
...
INSERT INTO "new_RecievingLog" ("bookAndPage", "branchNumber", "caseNumber", "caseType", "content", "createdAt", "dateRecieved", "id", "notes", "updatedAt") SELECT "bookAndPage", "branchNumber", "caseNumber", "caseType", "content", "createdAt", "dateRecieved", "id", "notes", "updatedAt" FROM "RecievingLog";
...
INSERT INTO "new_SpecialProceeding" ("caseNumber", "createdAt", "date", "id", "nature", "petitioner", "raffledTo", "respondent", "updatedAt") SELECT "caseNumber", "createdAt", "date", "id", "nature", "petitioner", "raffledTo", "respondent", "updatedAt" FROM "SpecialProceeding";
